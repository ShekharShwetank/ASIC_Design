...
# Generated on: Mon Aug 04 09:34:16 IST 2025 (Mon Aug 04 04:04:16 UTC 2025)
...
set logfile fv/sync_HA/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/sync_HA -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/sync_HA.v
elaborate_design -golden -root {sync_HA} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/sync_HA/fv_map.v.gz
elaborate_design -revised -root {sync_HA}
...
#add_name_alias fv/sync_HA/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.sync_HA.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.sync_HA.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.sync_HA.rtl.fv_map.rpt
