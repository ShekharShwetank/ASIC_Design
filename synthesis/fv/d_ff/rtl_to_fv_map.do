...
# Generated on: Mon Aug 11 12:46:24 IST 2025 (Mon Aug 11 07:16:24 UTC 2025)
...
set logfile fv/d_ff/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/d_ff -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/d_ff.v
elaborate_design -golden -root {d_ff} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/d_ff/fv_map.v.gz
elaborate_design -revised -root {d_ff}
...
set_system_mode lec
write_compared_points noneq.compared_points.d_ff.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.d_ff.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.d_ff.rtl.fv_map.rpt
