...
# Generated on: Mon Aug 04 09:08:38 IST 2025 (Mon Aug 04 03:38:38 UTC 2025)
...
set logfile fv/four_bitcounter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/four_bitcounter -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/four_bitcounter.v
elaborate_design -golden -root {four_bitcounter} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/four_bitcounter/fv_map.v.gz
elaborate_design -revised -root {four_bitcounter}
...
#add_name_alias fv/four_bitcounter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.four_bitcounter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.four_bitcounter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.four_bitcounter.rtl.fv_map.rpt
