...
create_delay_corner -name min_delay\
   ...
   -rc_corner rccorner
create_constraint_mode -name constraints_control_unit_fsm\
   -sdc_files\
    [list /dev/null]
create_analysis_view -name best_case -constraint_mode constraints_control_unit_fsm -delay_corner min_delay
create_analysis_view -name worst_case -constraint_mode constraints_control_unit_fsm -delay_corner max_delay
