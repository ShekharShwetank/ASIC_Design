...
# Generated on: Wed Nov 05 16:56:17 IST 2025 (Wed Nov 05 11:26:17 UTC 2025)
...
set logfile fv/pipeline_cpu/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/pipeline_cpu -revised fv_map
...
add_search_path /home/student/22BEC1204_ASIC_DESIGN/work -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/22BEC1204_ASIC_DESIGN/work/pipeline_control.v
elaborate_design -golden -root {pipeline_cpu} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/pipeline_cpu/fv_map.v.gz
elaborate_design -revised -root {pipeline_cpu}
...
#add_name_alias fv/pipeline_cpu/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.pipeline_cpu.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.pipeline_cpu.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.pipeline_cpu.rtl.fv_map.rpt
