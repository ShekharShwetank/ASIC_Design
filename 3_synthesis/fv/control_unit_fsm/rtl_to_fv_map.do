...
# Generated on: Tue Nov 04 18:44:47 IST 2025 (Tue Nov 04 13:14:47 UTC 2025)
...
set logfile fv/control_unit_fsm/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/control_unit_fsm -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/control_unit_fsm.v
elaborate_design -golden -root {control_unit_fsm} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/control_unit_fsm/fv_map.v.gz
elaborate_design -revised -root {control_unit_fsm}
...
#add_name_alias fv/control_unit_fsm/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.control_unit_fsm.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.control_unit_fsm.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.control_unit_fsm.rtl.fv_map.rpt
