...
# Generated on: Tue Nov 04 19:25:00 IST 2025 (Tue Nov 04 13:55:00 UTC 2025)
...
set logfile fv/resource_shared_datapath/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/resource_shared_datapath -revised fv_map
...
add_search_path /home/student/Desktop/22BEC1204_ASIC_DESIGN/work -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/resource_shared_datapath.v
elaborate_design -golden -root {resource_shared_datapath} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/resource_shared_datapath/fv_map.v.gz
elaborate_design -revised -root {resource_shared_datapath}
...
#add_name_alias fv/resource_shared_datapath/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.resource_shared_datapath.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.resource_shared_datapath.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.resource_shared_datapath.rtl.fv_map.rpt
