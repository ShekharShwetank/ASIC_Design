...
# Generated on: Tue Nov 04 18:06:00 IST 2025 (Tue Nov 04 12:36:00 UTC 2025)
...
set logfile fv/register_file/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/register_file -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/student/Desktop/22BEC1204_ASIC_DESIGN/work/register_file.v
elaborate_design -golden -root {register_file} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/register_file/fv_map.v.gz
elaborate_design -revised -root {register_file}
...
#add_name_alias fv/register_file/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.register_file.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.register_file.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.register_file.rtl.fv_map.rpt
