...
build_model \
    ...
    -designsource	 $WORKDIR/pipeline_cpu.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/pipeline_cpu.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 pipeline_cpu_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_pipeline_cpu_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 pipeline_cpu_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_pipeline_cpu_atpg
...
check_log log_commit_tests_FULLSCAN_pipeline_cpu_atpg
