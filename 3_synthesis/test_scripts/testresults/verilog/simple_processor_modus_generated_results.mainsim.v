...
//***************************************************************************//
//                                                                           //
//  FILE CREATED..............September 09, 2025 at 18:04:03                 //
//                                                                           //
...
//***************************************************************************//
  ...
  simple_processor
    simple_processor_inst (
      .clk      ( part_PIs[02] ),      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
      .rst_n    ( part_PIs[20] ),      // pinName = rst_n;  tf = +SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
      .start    ( part_PIs[22] ),      // pinName = start; testOffset = 0.000000;  scanOffset = 0.000000;  
      .op_sel   ( part_PIs[19] ),      // pinName = op_sel; testOffset = 0.000000;  scanOffset = 0.000000;  
      .in_a     ({part_PIs[10]  ,      // pinName = in_a[7]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[09]  ,      // pinName = in_a[6]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[08]  ,      // pinName = in_a[5]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[07]  ,      // pinName = in_a[4]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[06]  ,      // pinName = in_a[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[05]  ,      // pinName = in_a[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[04]  ,      // pinName = in_a[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[03]}),      // pinName = in_a[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      .in_b     ({part_PIs[18]  ,      // pinName = in_b[7]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[17]  ,      // pinName = in_b[6]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[16]  ,      // pinName = in_b[5]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[15]  ,      // pinName = in_b[4]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[14]  ,      // pinName = in_b[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[13]  ,      // pinName = in_b[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[12]  ,      // pinName = in_b[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
                  part_PIs[11]}),      // pinName = in_b[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      .result   ({part_POs[09]  ,      // pinName = result[7]; 
                  part_POs[08]  ,      // pinName = result[6]; 
                  part_POs[07]  ,      // pinName = result[5]; 
                  part_POs[06]  ,      // pinName = result[4]; 
                  part_POs[05]  ,      // pinName = result[3]; 
                  part_POs[04]  ,      // pinName = result[2]; 
                  part_POs[03]  ,      // pinName = result[1]; 
                  part_POs[02]}),      // pinName = result[0]; 
      .done     ( part_POs[01] ),      // pinName = done; 
      .SE       ( part_PIs[01] ),      // pinName = SE;  tf = +SE  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      .scan_in  ( part_PIs[21] ),      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
...
//***************************************************************************//
  ...
  assign ( weak0, weak1 ) // Termination 
    ...
    part_POs [2] = global_term,     // pinName = result[0]; 
    part_POs [3] = global_term,     // pinName = result[1]; 
    part_POs [4] = global_term,     // pinName = result[2]; 
    part_POs [5] = global_term,     // pinName = result[3]; 
    part_POs [6] = global_term,     // pinName = result[4]; 
    part_POs [7] = global_term,     // pinName = result[5]; 
    part_POs [8] = global_term,     // pinName = result[6]; 
    part_POs [9] = global_term,     // pinName = result[7]; 
...
//***************************************************************************//
  ...
  initial 
    begin 
      ...
      `ifdef sdf_annotate 
        `ifdef SDF_Minimum 
          $sdf_annotate ("default.sdf",simple_processor_inst,,"sdf_Min.log","MINIMUM");
        `endif 
        `ifdef SDF_Maximum 
          $sdf_annotate ("default.sdf",simple_processor_inst,,"sdf_Max.log","MAXIMUM");
        `endif 
        `ifdef SDF_Typical
          $sdf_annotate ("default.sdf",simple_processor_inst,,"sdf_Typ.log","TYPICAL");
        `endif 
      `endif 
...
//***************************************************************************//
  ...
  task sim_setup; 
    begin 
      ...
      name_POs [2] = "result[0]";      // pinName = result[0]; 
      name_POs [3] = "result[1]";      // pinName = result[1]; 
      name_POs [4] = "result[2]";      // pinName = result[2]; 
      name_POs [5] = "result[3]";      // pinName = result[3]; 
      name_POs [6] = "result[4]";      // pinName = result[4]; 
      name_POs [7] = "result[5]";      // pinName = result[5]; 
      name_POs [8] = "result[6]";      // pinName = result[6]; 
      name_POs [9] = "result[7]";      // pinName = result[7]; 
      ...
      stim_PIs = {22{1'bX}};   
      stim_CIs = 22'bX0XXXXXXXXXXXXXXXXX1XX; 
      meas_POs = {10{1'bX}};   
      stim_CR_1 = {27{1'b0}};   
      meas_OR_1 = {27{1'bX}};   
...
//***************************************************************************//
  ...
  task sim_vector_file; 
    begin 
      ...
      $display ( "\nINFO (TVE-189): Design:  simple_processor   Test Mode:  FULLSCAN   InExperiment:  logic " ); 
  ...
  task test_cycle; 
    begin 
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      ...
      part_PIs [3] = stim_PIs [3];      // pinName = in_a[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [4] = stim_PIs [4];      // pinName = in_a[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [5] = stim_PIs [5];      // pinName = in_a[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [6] = stim_PIs [6];      // pinName = in_a[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [7] = stim_PIs [7];      // pinName = in_a[4]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [8] = stim_PIs [8];      // pinName = in_a[5]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [9] = stim_PIs [9];      // pinName = in_a[6]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [10] = stim_PIs [10];      // pinName = in_a[7]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [11] = stim_PIs [11];      // pinName = in_b[0]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [12] = stim_PIs [12];      // pinName = in_b[1]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [13] = stim_PIs [13];      // pinName = in_b[2]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [14] = stim_PIs [14];      // pinName = in_b[3]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [15] = stim_PIs [15];      // pinName = in_b[4]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [16] = stim_PIs [16];      // pinName = in_b[5]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [17] = stim_PIs [17];      // pinName = in_b[6]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [18] = stim_PIs [18];      // pinName = in_b[7]; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [19] = stim_PIs [19];      // pinName = op_sel; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [21] = stim_PIs [21];      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [22] = stim_PIs [22];      // pinName = start; testOffset = 0.000000;  scanOffset = 0.000000;  
     #8.000000;        // 8.000000 ns;  From the start of the cycle.
      ...
      part_PIs [20] = stim_PIs [20];      // pinName = rst_n;  tf = +SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #8.000000;        // 16.000000 ns;  From the start of the cycle.
      ...
      part_PIs [20] = stim_CIs [20];      // pinName = rst_n;  tf = +SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #56.000000;        // 72.000000 ns;  From the start of the cycle.

      for ( POnum = 1; POnum <= 10; POnum = POnum + 1 ) begin 
        if (( part_POs [ POnum ] !== meas_POs [ POnum ] ) & ( meas_POs [ POnum ] !== 1'bX )) begin 
          ...
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "simple_processor", name_POs [ POnum ], PATTERN, -1, part_POs [ POnum ] ); 
          end  
        end  
  ...
  task Scan_Sequence_TM_1_SEQ_2_SOP_1; 
    begin 
      ...
      for ( SCANCYCLE = 1; SCANCYCLE <= MAX; SCANCYCLE = SCANCYCLE + 1 ) begin 
        ...
        SERIALCYCLE = SERIALCYCLE + 1; 
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
        part_PIs [21] = stim_CR_1 [ 0 + SCANCYCLE ];      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
     #8.000000;        // 8.000000 ns;  From the start of the cycle.
        ...
        if (( part_POs [10] !== meas_OR_1 [ 0 + SCANCYCLE ] ) & ( meas_OR_1 [ 0 + SCANCYCLE ] !== 1'bX )) begin      // pinName = scan_out;  tf =  SO  ; 
          ...
          if (( failset ) & ( FAILSETID == 0 ))  failset_setup; 
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "simple_processor", name_POs [10], PATTERN, SCANCYCLE, part_POs [10] ); 
          end  
        end  
        else  begin 
  ...
  task cmd_code; 
    begin 
      ...
      case ( CMD ) 
        ...
        200: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", stim_PIs [1:22] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
        ...
        201: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", stim_CIs [1:22] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
        ...
        202: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", meas_POs [1:10] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", stim_CR_1 [1:27] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", meas_OR_1 [1:27] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
        ...
        904: begin 
          ...
          if ( rc_read > 0 )  begin 
            `ifdef MISCOMPAREDEBUG 
              if ( diag_debug ) begin 
                $processSimulationDebugFile ( DIAG_DEBUG_FILE, "simple_processor_inst", eventID ); 
              end 
            `endif 
          end  
          else  bad_cmd_code; 
