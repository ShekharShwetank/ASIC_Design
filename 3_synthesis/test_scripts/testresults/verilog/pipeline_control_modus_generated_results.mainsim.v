...
//***************************************************************************//
//                                                                           //
//  FILE CREATED..............November 05, 2025 at 17:27:49                  //
//                                                                           //
...
//***************************************************************************//
  ...
  pipeline_cpu
    pipeline_cpu_inst (
      .clk          ( part_PIs[002] ),      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
      .rst          ( part_PIs[003] ),      // pinName = rst;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
      .debug_reg_r4 ({part_POs[025]  ,      // pinName = debug_reg_r4[31]; 
                      part_POs[024]  ,      // pinName = debug_reg_r4[30]; 
                      part_POs[022]  ,      // pinName = debug_reg_r4[29]; 
                      part_POs[021]  ,      // pinName = debug_reg_r4[28]; 
                      part_POs[020]  ,      // pinName = debug_reg_r4[27]; 
                      part_POs[019]  ,      // pinName = debug_reg_r4[26]; 
                      part_POs[018]  ,      // pinName = debug_reg_r4[25]; 
                      part_POs[017]  ,      // pinName = debug_reg_r4[24]; 
                      part_POs[016]  ,      // pinName = debug_reg_r4[23]; 
                      part_POs[015]  ,      // pinName = debug_reg_r4[22]; 
                      part_POs[014]  ,      // pinName = debug_reg_r4[21]; 
                      part_POs[013]  ,      // pinName = debug_reg_r4[20]; 
                      part_POs[011]  ,      // pinName = debug_reg_r4[19]; 
                      part_POs[010]  ,      // pinName = debug_reg_r4[18]; 
                      part_POs[009]  ,      // pinName = debug_reg_r4[17]; 
                      part_POs[008]  ,      // pinName = debug_reg_r4[16]; 
                      part_POs[007]  ,      // pinName = debug_reg_r4[15]; 
                      part_POs[006]  ,      // pinName = debug_reg_r4[14]; 
                      part_POs[005]  ,      // pinName = debug_reg_r4[13]; 
                      part_POs[004]  ,      // pinName = debug_reg_r4[12]; 
                      part_POs[003]  ,      // pinName = debug_reg_r4[11]; 
                      part_POs[002]  ,      // pinName = debug_reg_r4[10]; 
                      part_POs[032]  ,      // pinName = debug_reg_r4[9]; 
                      part_POs[031]  ,      // pinName = debug_reg_r4[8]; 
                      part_POs[030]  ,      // pinName = debug_reg_r4[7]; 
                      part_POs[029]  ,      // pinName = debug_reg_r4[6]; 
                      part_POs[028]  ,      // pinName = debug_reg_r4[5]; 
                      part_POs[027]  ,      // pinName = debug_reg_r4[4]; 
                      part_POs[026]  ,      // pinName = debug_reg_r4[3]; 
                      part_POs[023]  ,      // pinName = debug_reg_r4[2]; 
                      part_POs[012]  ,      // pinName = debug_reg_r4[1]; 
                      part_POs[001]}),      // pinName = debug_reg_r4[0]; 
      .SE           ( part_PIs[001] ),      // pinName = SE;  tf = +SE  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      .scan_in      ( part_PIs[004] ),      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      .scan_out     ( part_POs[033] )     // pinName = scan_out;  tf =  SO  ; 
      );
...
//***************************************************************************//
  ...
  assign ( weak0, weak1 ) // Termination 
    part_POs [1] = global_term,     // pinName = debug_reg_r4[0]; 
    part_POs [2] = global_term,     // pinName = debug_reg_r4[10]; 
    part_POs [3] = global_term,     // pinName = debug_reg_r4[11]; 
    part_POs [4] = global_term,     // pinName = debug_reg_r4[12]; 
    part_POs [5] = global_term,     // pinName = debug_reg_r4[13]; 
    part_POs [6] = global_term,     // pinName = debug_reg_r4[14]; 
    part_POs [7] = global_term,     // pinName = debug_reg_r4[15]; 
    part_POs [8] = global_term,     // pinName = debug_reg_r4[16]; 
    part_POs [9] = global_term,     // pinName = debug_reg_r4[17]; 
    part_POs [10] = global_term,     // pinName = debug_reg_r4[18]; 
    part_POs [11] = global_term,     // pinName = debug_reg_r4[19]; 
    part_POs [12] = global_term,     // pinName = debug_reg_r4[1]; 
    part_POs [13] = global_term,     // pinName = debug_reg_r4[20]; 
    part_POs [14] = global_term,     // pinName = debug_reg_r4[21]; 
    part_POs [15] = global_term,     // pinName = debug_reg_r4[22]; 
    part_POs [16] = global_term,     // pinName = debug_reg_r4[23]; 
    part_POs [17] = global_term,     // pinName = debug_reg_r4[24]; 
    part_POs [18] = global_term,     // pinName = debug_reg_r4[25]; 
    part_POs [19] = global_term,     // pinName = debug_reg_r4[26]; 
    part_POs [20] = global_term,     // pinName = debug_reg_r4[27]; 
    part_POs [21] = global_term,     // pinName = debug_reg_r4[28]; 
    part_POs [22] = global_term,     // pinName = debug_reg_r4[29]; 
    part_POs [23] = global_term,     // pinName = debug_reg_r4[2]; 
    part_POs [24] = global_term,     // pinName = debug_reg_r4[30]; 
    part_POs [25] = global_term,     // pinName = debug_reg_r4[31]; 
    part_POs [26] = global_term,     // pinName = debug_reg_r4[3]; 
    part_POs [27] = global_term,     // pinName = debug_reg_r4[4]; 
    part_POs [28] = global_term,     // pinName = debug_reg_r4[5]; 
    part_POs [29] = global_term,     // pinName = debug_reg_r4[6]; 
    part_POs [30] = global_term,     // pinName = debug_reg_r4[7]; 
    part_POs [31] = global_term,     // pinName = debug_reg_r4[8]; 
    part_POs [32] = global_term,     // pinName = debug_reg_r4[9]; 
    part_POs [33] = global_term;      // pinName = scan_out;  tf =  SO  ; 
...
//***************************************************************************//
  ...
  initial 
    begin 
      ...
      `ifdef sdf_annotate 
        `ifdef SDF_Minimum 
          $sdf_annotate ("default.sdf",pipeline_cpu_inst,,"sdf_Min.log","MINIMUM");
        `endif 
        `ifdef SDF_Maximum 
          $sdf_annotate ("default.sdf",pipeline_cpu_inst,,"sdf_Max.log","MAXIMUM");
        `endif 
        `ifdef SDF_Typical
          $sdf_annotate ("default.sdf",pipeline_cpu_inst,,"sdf_Typ.log","TYPICAL");
        `endif 
      `endif 
...
//***************************************************************************//
  ...
  task sim_setup; 
    begin 
      ...
      SERIALCYCLE = 0; 
      SEQNUM = 0; 
      name_POs [1] = "debug_reg_r4[0]";      // pinName = debug_reg_r4[0]; 
      name_POs [2] = "debug_reg_r4[10]";      // pinName = debug_reg_r4[10]; 
      name_POs [3] = "debug_reg_r4[11]";      // pinName = debug_reg_r4[11]; 
      name_POs [4] = "debug_reg_r4[12]";      // pinName = debug_reg_r4[12]; 
      name_POs [5] = "debug_reg_r4[13]";      // pinName = debug_reg_r4[13]; 
      name_POs [6] = "debug_reg_r4[14]";      // pinName = debug_reg_r4[14]; 
      name_POs [7] = "debug_reg_r4[15]";      // pinName = debug_reg_r4[15]; 
      name_POs [8] = "debug_reg_r4[16]";      // pinName = debug_reg_r4[16]; 
      name_POs [9] = "debug_reg_r4[17]";      // pinName = debug_reg_r4[17]; 
      name_POs [10] = "debug_reg_r4[18]";      // pinName = debug_reg_r4[18]; 
      name_POs [11] = "debug_reg_r4[19]";      // pinName = debug_reg_r4[19]; 
      name_POs [12] = "debug_reg_r4[1]";      // pinName = debug_reg_r4[1]; 
      name_POs [13] = "debug_reg_r4[20]";      // pinName = debug_reg_r4[20]; 
      name_POs [14] = "debug_reg_r4[21]";      // pinName = debug_reg_r4[21]; 
      name_POs [15] = "debug_reg_r4[22]";      // pinName = debug_reg_r4[22]; 
      name_POs [16] = "debug_reg_r4[23]";      // pinName = debug_reg_r4[23]; 
      name_POs [17] = "debug_reg_r4[24]";      // pinName = debug_reg_r4[24]; 
      name_POs [18] = "debug_reg_r4[25]";      // pinName = debug_reg_r4[25]; 
      name_POs [19] = "debug_reg_r4[26]";      // pinName = debug_reg_r4[26]; 
      name_POs [20] = "debug_reg_r4[27]";      // pinName = debug_reg_r4[27]; 
      name_POs [21] = "debug_reg_r4[28]";      // pinName = debug_reg_r4[28]; 
      name_POs [22] = "debug_reg_r4[29]";      // pinName = debug_reg_r4[29]; 
      name_POs [23] = "debug_reg_r4[2]";      // pinName = debug_reg_r4[2]; 
      name_POs [24] = "debug_reg_r4[30]";      // pinName = debug_reg_r4[30]; 
      name_POs [25] = "debug_reg_r4[31]";      // pinName = debug_reg_r4[31]; 
      name_POs [26] = "debug_reg_r4[3]";      // pinName = debug_reg_r4[3]; 
      name_POs [27] = "debug_reg_r4[4]";      // pinName = debug_reg_r4[4]; 
      name_POs [28] = "debug_reg_r4[5]";      // pinName = debug_reg_r4[5]; 
      name_POs [29] = "debug_reg_r4[6]";      // pinName = debug_reg_r4[6]; 
      name_POs [30] = "debug_reg_r4[7]";      // pinName = debug_reg_r4[7]; 
      name_POs [31] = "debug_reg_r4[8]";      // pinName = debug_reg_r4[8]; 
      name_POs [32] = "debug_reg_r4[9]";      // pinName = debug_reg_r4[9]; 
      name_POs [33] = "scan_out";      // pinName = scan_out;  tf =  SO  ; 
...
//***************************************************************************//
  ...
  task sim_vector_file; 
    begin 
      ...
      $display ( "\nINFO (TVE-189): Design:  pipeline_cpu   Test Mode:  FULLSCAN   InExperiment:  logic " ); 
  ...
  task test_cycle; 
    begin 
     ...
     #8.000000;        // 8.000000 ns;  From the start of the cycle.
      ...
      part_PIs [3] = stim_PIs [3];      // pinName = rst;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #8.000000;        // 16.000000 ns;  From the start of the cycle.
      ...
      part_PIs [3] = stim_CIs [3];      // pinName = rst;  tf = -SC  ; testOffset = 8.000000;  scanOffset = 0.000000;  
     #56.000000;        // 72.000000 ns;  From the start of the cycle.

      for ( POnum = 1; POnum <= 33; POnum = POnum + 1 ) begin 
        if (( part_POs [ POnum ] !== meas_POs [ POnum ] ) & ( meas_POs [ POnum ] !== 1'bX )) begin 
          ...
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "pipeline_cpu", name_POs [ POnum ], PATTERN, -1, part_POs [ POnum ] ); 
          end  
        end  
  ...
  task Scan_Sequence_TM_1_SEQ_2_SOP_1; 
    begin 
      ...
      for ( SCANCYCLE = 1; SCANCYCLE <= MAX; SCANCYCLE = SCANCYCLE + 1 ) begin 
        ...
        SERIALCYCLE = SERIALCYCLE + 1; 
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
        part_PIs [4] = stim_CR_1 [ 0 + SCANCYCLE ];      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
     #8.000000;        // 8.000000 ns;  From the start of the cycle.

        if (( part_POs [33] !== meas_OR_1 [ 0 + SCANCYCLE ] ) & ( meas_OR_1 [ 0 + SCANCYCLE ] !== 1'bX )) begin      // pinName = scan_out;  tf =  SO  ; 
          if ( test_num != failed_test_num )  begin 
            num_failed_tests = num_failed_tests + 1; 
            failed_test_num = test_num; 
          end  
          ...
          $display ( "           Expected: %0b   Simulated: %0b   Observe Register (OR) = 1;   Measured on Scan Cycle: %0d   Measured at SO: %0s   ", meas_OR_1 [ 0 + SCANCYCLE ], part_POs [33], SCANCYCLE, name_POs [33] ); 

          if (( failset ) & ( FAILSETID == 0 ))  failset_setup; 
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "pipeline_cpu", name_POs [33], PATTERN, SCANCYCLE, part_POs [33] ); 
          end  
        end  
        else  begin 
  ...
  task cmd_code; 
    begin 
      ...
      case ( CMD ) 
        ...
        200: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", stim_PIs [1:4] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
        ...
        201: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", stim_CIs [1:4] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
        ...
        202: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", meas_POs [1:33] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", stim_CR_1 [1:205] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", meas_OR_1 [1:205] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
        ...
        904: begin 
          ...
          if ( rc_read > 0 )  begin 
            `ifdef MISCOMPAREDEBUG 
              if ( diag_debug ) begin 
                $processSimulationDebugFile ( DIAG_DEBUG_FILE, "pipeline_cpu_inst", eventID ); 
              end 
            `endif 
          end  
          else  bad_cmd_code; 
