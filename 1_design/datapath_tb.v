...
module datapath_tb;
    ...
    initial begin
        ...
        // Test 3: Toggle coverage (all 1s / 0s)
        // (255 + 1) * (0 - 1) = 256 * -1 = -256
        apply_and_check(8'hFF, 8'h01, 8'h00, 8'h01, -18'd256);
        
        // Test 4: Checkerboard patterns
        // (0xAA + 0x55) * (0x55 - 0xAA) = (170 + 85) * (85 - 170) = 255 * -85 = -21675
        apply_and_check(8'hAA, 8'h55, 8'h55, 8'hAA, -18'd21675);
